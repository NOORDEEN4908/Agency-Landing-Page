...
const Hero = () => {
  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-12 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white' >
...
<h1 className='text-4x1 sm: text-5x1 md:text-6x1 xl:text-[84px] font-medium
xl:leading-[95px] max-w-5x1'>Turning imagination into <span
